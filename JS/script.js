...
function draw(){
    ...
    drawRect(player1); //Se dibuja el jugador1
    drawRect(player2); //Se dibuja el jugador2
...
function update(){
    ...
    if(ball.x < 0 || ball.x > canvas.width){
        ...
        //Se obtiene una posición aleatoria de velocidad en el eje "Y" y se incrementa o disminuye la velocidad de acuerdo al random
...
window.addEventListener('keydown', (event)=>{
    ...
    if(key === 'ArrowDown' && player2.y + player2.height < canvas.height) player2.y +=10; //Si el jugador2 presiona la flecha hacia abajo se reduce (mueve) en 10 pixeles hacia abajo
